...
urlpatterns = [
    ...
    #3.2 GET and PUT , DELETE from rest framework function based view @api_view
    path('rest/fbv/<int:pk>',views.FBV_pk),
    #4.1 GET and POST from rest framework class based view @api_view
   ...
   path('rest/mixins/<int:pk>', views.mixins_pk.as_view()),
    ...
    #6.1 GET and POST from rest framework class based view mixins
